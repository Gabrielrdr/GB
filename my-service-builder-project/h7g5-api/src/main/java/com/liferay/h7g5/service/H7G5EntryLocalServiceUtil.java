...
public class H7G5EntryLocalServiceUtil {
	...
	public static H7G5Entry findH7G5EntriesByKeyWithDynamic(String key) {
		return getService().findH7G5EntriesByKeyWithDynamic(key);
	}

	public static List<H7G5Entry> findH7G5EntriesByNameWithDynamic(
		String name) {
